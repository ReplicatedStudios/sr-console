...
export default class SrConsole {
    ...
    /**
     * La funcion por defecto que envia un mensaje al stdout (alias la consola)
    ...
    /**
     * Envia un mensaje de advertencia color amarillo al stderr
     * @param {any} messages Valores a mostrar en la consola
     */
    public warn(...messages: any[]): void {
        SrConsole.printing("YELLOW", ...messages);
    };
